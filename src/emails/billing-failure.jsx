      ...
      <Tailwind>
        <Body className="bg-white font-sans">
          <Container className="mx-auto py-12 px-4 max-w-xl">
            <Text className="text-2xl font-bold text-black">MGorg</Text>
            ...
            <Text className="text-base text-gray-700 leading-6">
              ...
              your information so you can keep using MGorg
            </Text>
            ...
            <Text className="text-sm text-gray-500">
              If you didn&apos;t create an account with MGorg, you can safely
              ignore this email.
            </Text>
          </Container>
        </Body>
